...
const { addGoods,getGoods,deleteGoods,changeGoods,searchGoods } = require("../service/goodsService.js");
...
router.post('/changeGoods', async function (req, res, next) {
    res.send(await changeGoods(req.body));
});
router.post('/searchGoods', async function (req, res, next) {
